// Solução encontrada por Edmilson Neto - Turma 10-A
...
describe('Test url create "products"', () => {
  ...
  describe('result of create products', () => {
    it('must have to be an product', () => products.newProduct(fakeProduct)
        .then((res) => expect(res).to.be.an('object')));

    it('products must have props: id, name, quantity', () => products.newProduct(anotherProduct)
        .then((res) => expect(res).to.include.all.keys('connection', 'insertedCount', 'insertedId', 'message', 'ops', 'result')));
  });
});
...
describe('Test url getByID "products"', () => {
  ...
  describe('no data on DB', () => {
    it('returns null', () => products.searchById()
  ...
  describe('db with data', () => {
    ...
    it('must have to be an object', () => products.searchById(fakeID)
      .then((res) => expect(res).to.be.an('object')));

    it('object must have props: id, name, quantity', () => products.searchById(fakeID)
...
describe('Test url update "products"', () => {
  ...
  describe('result of update product', () => {
    ...
    it('must have to be an object', () => products.updateProduct(_id, fakeProduct)
        .then((res) => expect(res).to.be.an('object')));

    it('object must have new props: id, name, quantity', () => products.updateProduct(_id, fakeReplace)
        .then((res) => expect(res.modifiedCount).to.equal(undefined)));
  });
});
...
describe('Test url remove "products"', () => {
  ...
  describe('result of remove', () => {
    ...
    it('product must have to result null', () => products.deleteProduct(_id)
        .then(() => products.searchById(_id)
        .then((res) => expect(res).to.be.null)));
  });
});
...
describe('Test url create "sales"', () => {
  ...
  describe('result of create', () => {
    it('must have to be an array', () => sales.inputSales(itensSold)
        .then(({ itensSold }) => expect(itensSold).to.be.an('array')));

    it('array must have props: id, name, quantity', () => sales.inputSales(itensSold)
...
describe('Test url getById "sales', () => {
  ...
  describe('no data on DB', () => {
    it('returns null', () => sales.searchSale()
      .then((res) => expect(res).to.be.null));
  });
  ...
  describe('db with data', () => {
    ...
    it('must have to be an object', () => sales.searchSale(_id)
      .then((res) => expect(res).to.be.an('object')));

    it('object must have props: id, name, quantity', () => sales.searchSale(_id)
...
describe('Test url update "sales"', () => {
  ...
  describe('result of update', () => {
    ...
    it('must have to be an object', () => sales.updateSale(_id, itensSold)
        .then((res) => expect(res).to.be.an('object')));

    it('object must have new props: id, name, quantity', () => sales.updateSale(_id, newItens)
        .then((res) => expect(res.modifiedCount).to.equal(undefined)));
  });
});
...
describe('Test url remove "sales"', () => {
  ...
  describe('test return stock', () => {
    ...
    it('return stock', () => sales.returnStock(_id) 
      .then(() => products.searchById(_id))
      .then((res) => expect(res).to.be.null));
  })
});