...
describe('Testando productsModel', () => {
  ...
  describe('Testa a inserção de produtos no banco de dados', () => {
    describe('Quando é inserido com sucesso', () => {
      ...
      before(async () => {
        response = await productsModel.create('Produto do Batista', 100);
      });
    ...
    describe('Quando há falha na inserção', () => {
      ...
      before(async () => {
        response = await productsModel.create('Produto', 100);
      });
      ...
      describe('Quando o produto já existe no banco', () => {
        it('Deve retornar null', async () => {
          const duplicityResponse = await productsModel.create('Produto', 100);
  ...
  describe('Testa a atualização de produtos', async () => {
    ...
    before(async () => {
      productToBeUpdated = await productsModel.create('Produto', 100);
    });
    ...
    describe('Quando a atualização é realizada com sucesso', () => {
      it('O retorno deve ter as caracteristicas desejadas', async () => {
        await productsModel.updateProduct(productToBeUpdated._id, 'Atualizou!', 999);
    ...
    describe('Quando há erro na atualização', () => {
      it('Deve-se retornar null', async () => {
        const invalidId = '111';
        const updatedProduct = await productsModel.updateProduct(invalidId, '', 0);
  ...
  describe('Testa a deleção de produtos', () => {
    describe('Quando a deleção é realizada com sucesso', () => {
      ...
      before(async () => {
        productToBeDeleted = await productsModel.create('Produto', 100);
      });

      it('Deve retornar um array', async () => {
        await productsModel.deleteProduct(productToBeDeleted._id);
...
describe('Testando salesModel', () => {
  ...
  before(async () => {
    ...
    existentProduct = await productsModel.create('Produto teste', 100);
  });
