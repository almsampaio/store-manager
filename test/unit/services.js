...
const modelLayerP = require('../../models/productModel');
const modelLayerS = require('../../models/salesModel');
const servicesLayerP = require('../../services/productsService');
const servicesLayerS = require('../../services/salesServices');
